...
class VideoRenderer implements GLTextureView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    private void prepareSurface() {
        ...
        Surface realSurface = new Surface(this.surface);
        System.out.println("VideoRenderer Higgs this is " + this.toString() + " about to report surface " + realSurface.toString());
        onSurfacePrepareListener.surfacePrepared(realSurface);
