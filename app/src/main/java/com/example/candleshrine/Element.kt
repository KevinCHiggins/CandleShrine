...
class Element(_context: Context, _uri: Uri, surface: Surface): TextureView.SurfaceTextureListener {
    ...
    var extractorAdvanced: Boolean = true
    ...
    init {
         ...
         */
            Log.d(TAG, "Building codec as Surface is available")
            buildCodec(surface)
    ...
    fun buildCodec(s: Surface) {
        codec.configure(formatType, s, null, 0)
